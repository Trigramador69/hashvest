...
export const zhCN: TranslationDictionary = {
  ...
  "ai.review.linksUnread":
    "未下载或验证链接内容。本分析仅使用提交的备注、证据日期及 HSK 当前读取结果。",
  "ai.review.disclaimer":
    "仅供参考。请核查来源并自行决定。批准须使用现有审核操作和你的钱包；此区域无法执行批准。",
  "ai.review.summary": "进度摘要",
  "ai.review.findings": "证据缺口与不一致",
  "ai.review.questions": "向提交者提问",
  "ai.review.uncertainty": "局限与不确定性",
  "ai.review.recommendation": "非约束性建议",
  "ai.review.approve": "核查来源后考虑批准",
  "ai.review.request_information": "请求更多信息",
  "ai.review.insufficient_information": "信息不足",
  "ai.review.sources": "使用的来源",
  "ai.review.chainSource": "当前 HSK 赠款读取结果",
  "ai.review.evidenceSource": "里程碑 {index} 的证据",
  "ai.review.checkedAt": "查询时间：{date} · 区块 {block}",
  "ai.review.evidenceDate": "更新时间：{date}",
  "ai.review.stale": "上下文已更改或分析已超过五分钟。请重新生成后再使用建议。",
  "ai.review.missingNotes":
    "部分待审核里程碑没有可用的证据备注，无法评估链接内容。",
  "ai.review.open": "打开证据分析",
