...
| Area                   | Covered by                                                                                                                                                       |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Migration              | Applied to a clean PostgreSQL alongside the existing migration, with SQL assertions for every constraint above; a CI test pins the migration's security posture. |
