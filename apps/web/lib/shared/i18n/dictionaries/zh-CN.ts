...
export const zhCN: TranslationDictionary = {
  ...
  "detail.milestone.quorumProgress": "{approvals}/{threshold} 次批准",
  "detail.milestone.approvedByYou": "您已批准 ({approvals}/{threshold})",
  "detail.milestone.waitingQuorum": "等待法定人数 ({approvals}/{threshold})",
  "detail.terms.quorumReviewers": "审核人（法定人数 {threshold}/{count}）",
  ...
  "wizard.quorum.modeLabel": "审核人配置",
  "wizard.quorum.singleReviewer": "单一审核人",
  "wizard.quorum.multiReviewer": "多审核人法定人数 (M-of-N)",
  "wizard.quorum.multiReviewerHint":
    "在里程碑解锁之前，需要多位指定审核人的批准。",
  "wizard.quorum.thresholdLabel": "批准阈值 (M of N)",
  "wizard.quorum.thresholdHint": "解锁每个里程碑所需的独立审核人批准数。",
  "wizard.quorum.reviewersCount": "指定审核人 ({count}/10)",
  "wizard.quorum.addReviewer": "添加审核人 +",
  "wizard.quorum.removeReviewer": "移除",
  "wizard.quorum.reviewerPlaceholder": "审核人地址 (0x…)",
  "wizard.quorum.thresholdOption": "需要 {total} 位审核人中的 {threshold} 位",
  ...
  "wizard.review.quorumReviewers": "审核人（法定人数 {threshold}/{count}）",
  ...
  "wizard.error.invalidQuorumCount": "法定人数需要添加 1 到 10 位审核人。",
  "wizard.error.duplicateReviewer": "不允许重复的审核人地址。",
  "wizard.error.invalidQuorumReviewer": "审核人 {index} 不是有效地址。",
  "wizard.error.invalidThreshold": "阈值必须在 1 和审核人数量之间。",
