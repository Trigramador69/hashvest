...
- AI tools use independent collapsible sections in the Template step, new-template editor and private milestone evidence. Review analysis requires organization membership and canonical grant association, uses server-authorized notes and live HSK reads, cites known sources and never downloads evidence links or executes recommendations. Manual creation and approval remain available on provider failure.
