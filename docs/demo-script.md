...
| 2:40–3:00 | **Close**         | Switch the language selector to 简体中文 and back.                                                      | "It works in English, Chinese, and Spanish. It's live on HSK testnet today, and the roadmap goes to batch grant rounds, milestone evidence, and an audit before mainnet. Thank you."                              |
