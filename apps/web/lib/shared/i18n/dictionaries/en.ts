...
export const en = {
  ...
  "overview.review.evidence.title": "Pending milestone evidence",
  ...
  "detail.evidence.retry": "Retry",
  "detail.evidence.empty": "No evidence submitted for this milestone.",
  "detail.evidence.unsafeLink": "This evidence link is not safe to open.",
  "detail.evidence.status.submitted": "Submitted",
  "detail.evidence.submitter": "Submitted by",
  "detail.evidence.created": "Created",
  "detail.evidence.updated": "Updated",
  "detail.evidence.note": "Note",
  "detail.evidence.type.githubPr": "GitHub PR",
  "detail.evidence.type.githubCommit": "GitHub commit",
  "detail.evidence.type.deployment": "Deployment",
  "detail.evidence.type.document": "Document",
