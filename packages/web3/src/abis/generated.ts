...
export const hashVestFactoryAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "reviewers", type: "address[]", internalType: "address[]" },
...
export const quorumGrantVaultAbi = [
  {
    type: "constructor",
    inputs: [
      { name: "issuer_", type: "address", internalType: "address" },
      ...
      { name: "reviewers_", type: "address[]", internalType: "address[]" },
      { name: "threshold_", type: "uint256", internalType: "uint256" },
      {
        name: "inputs",
        type: "tuple[]",
        internalType: "struct MilestoneInput[]",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "reviewer_", type: "address", internalType: "address" },
    ],
    outputs: [{ name: "", type: "bool", internalType: "bool" }],
    stateMutability: "view",
  },
  ...
  {
    type: "event",
    name: "MilestoneApprovalSubmitted",
    inputs: [
      {
        name: "reviewer",
        type: "address",
  ...
  { type: "error", name: "AlreadyRevoked", inputs: [] },
  { type: "error", name: "BeneficiaryNotEligible", inputs: [] },
  { type: "error", name: "DuplicateReviewer", inputs: [] },
  { type: "error", name: "GrantNotRevocable", inputs: [] },
  { type: "error", name: "InvalidAddress", inputs: [] },
  { type: "error", name: "InvalidAllocation", inputs: [] },
  { type: "error", name: "InvalidInitialUnlock", inputs: [] },
  { type: "error", name: "InvalidMilestoneIndex", inputs: [] },
  { type: "error", name: "InvalidMilestones", inputs: [] },
  { type: "error", name: "InvalidQuorumThreshold", inputs: [] },
  { type: "error", name: "InvalidSchedule", inputs: [] },
  { type: "error", name: "MilestoneAlreadyApproved", inputs: [] },
  { type: "error", name: "NothingToClaim", inputs: [] },
  { type: "error", name: "ReentrancyGuardReentrantCall", inputs: [] },
  { type: "error", name: "ReviewerAlreadyApproved", inputs: [] },
  {
    type: "error",
    name: "SafeERC20FailedOperation",
    inputs: [{ name: "token", type: "address", internalType: "address" }],
